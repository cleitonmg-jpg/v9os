...
import {
  ...
  Search, ShieldCheck, LogOut, Phone, Mail, MapPin, UserCog, Eye, EyeOff
} from 'lucide-react';
...
const emptyForm: EmpresaForm = {
  ...
  email: '', observacao: '', usuario: '', senha: '',
};
...
export const AdminRoot = () => {
  ...
  const [modal, setModal] = useState<'create' | 'edit' | 'perfil' | null>(null);
  ...
  const openEdit = (emp: Empresa) => {
    setForm({
      ...
      observacao: emp.observacao || '', usuario: emp.usuario_admin, senha: '',
    });
    setEditId(emp.id);
    setError('');
    setModal('edit');
